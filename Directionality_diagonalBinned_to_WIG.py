...
def Score_boundaries(bin_counts, sizes, chromosomes):
	bin_size = int(options.bin_size)
	width = int(options.width)
	diagonal_skip = int(options.diagonal_skip)
	outfilename = options.file_stem + '_w' + str(width) + 'd' + str(diagonal_skip) + '.WIG'
	outfile = open(outfilename,'w')
	name = 'width' + str(width) + '_skip' + str(diagonal_skip)
...
Score_boundaries(bin_counts, sizes, chromosomes)
